...
const generatorCaptcha = async (ipAddress) => {
    ...
    try {
        ...
        await loadImage(`../public/images/bgCaptcha${Math.ceil(Math.random() * 2)}.png`)
...
const verifyCaptcha = async (ipAddress, textCaptchaClient) => {
    try {
...
module.exports = {
    generatorCaptcha, verifyCaptcha
}